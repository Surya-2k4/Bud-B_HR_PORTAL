      ...
      <div className="flex items-center gap-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-48 rounded-2xl p-2 glass dark:glass-dark border-border/50 shadow-2xl">
            ...
            <DropdownMenuItem onClick={() => setStatusFilter('approved')} className="rounded-xl p-3 cursor-pointer focus:bg-emerald-500/10 text-emerald-500 transition-colors font-medium">Approved Only</DropdownMenuItem>
            <DropdownMenuItem onClick={() => setStatusFilter('pending')} className="rounded-xl p-3 cursor-pointer focus:bg-amber-500/10 text-amber-500 transition-colors font-medium">Pending Only</DropdownMenuItem>
            <DropdownMenuItem onClick={() => setStatusFilter('rejected')} className="rounded-xl p-3 cursor-pointer focus:bg-destructive/10 text-destructive transition-colors font-medium">Rejected Only</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
